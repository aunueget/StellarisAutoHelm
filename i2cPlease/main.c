...
//!
//! This example shows how to configure the I2C1 module for loopback mode.
...
//! - I2C1 peripheral
//! - GPIO Port B peripheral (for I2C1 pins)
//! - I2C1SCL - PB2
//! - I2C1SDA - PB3
//!
...
unsigned long ulindex;
    ...
    //
    // Enable the I2C1 slave module. This module is enabled only for testing
    ...
    for(ulindex = 0; ulindex < NUM_I2C_DATA; ulindex++)
    {
        ...
        //
        I2CMasterDataPut(I2C1_MASTER_BASE, ulDataTx[ulindex]);
        ...
        //
        while(!(I2CSlaveStatus(I2C1_SLAVE_BASE) & I2C_SCSR_RREQ))
        {
        }
        ...
        //
        ulDataRx[ulindex] = I2CSlaveDataGet(I2C1_SLAVE_BASE);
    ...
    {
        //
        // Display the data that I2C1 slave module is transferring.
        //
        UARTprintf("  Sending: '%c'  . . .  ", ulDataTx[ulindex]);
        ...
        // Place the data to be sent in the data register
        //
        I2CSlaveDataPut(I2C1_SLAVE_BASE, ulDataTx[ulindex]);
        ...
        //
        ulDataRx[ulindex] = I2CMasterDataGet(I2C1_MASTER_BASE);
