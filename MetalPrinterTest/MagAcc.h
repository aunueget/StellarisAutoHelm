...
extern float get_digital_heading(void);
extern float heading_from(vector from);
...
extern char* floatToString(char* numberAsString,float num);
extern void clearOutput(char* output);
extern void calibrateAcc(vector *a);
extern void calibrateMag(vector *m);
extern void smoothVector(vector *curr,vector *previos);
